import { BarChart3, Bell, Heart, Home, Menu, Search, TrendingDown, User } from "lucide-react";
      ...
      <div className="container flex h-16 items-center justify-between px-4 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" className="relative">
            ...
            <Badge className="absolute -right-1 -top-1 h-5 w-5 rounded-full p-0 flex items-center justify-center text-xs bg-violet-600">
              3
            </Badge>
          </Button>
