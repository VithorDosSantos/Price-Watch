        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {token ? (
            <div className="flex items-center gap-2">
              {user?.role === "ADMIN" && (
                <Link to="/admin" className="text-sm text-violet-600">
                  Admin
                </Link>
              )}
              <Button
              ...
              <Button
                variant="ghost"
                className="text-sm text-gray-700 hidden sm:inline-flex"
                onClick={() => {
                  logout();
                  navigate("/");
                }}
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/register" className="text-sm text-violet-600 hidden sm:inline">
                Criar conta
              </Link>
            </div>
          )}
